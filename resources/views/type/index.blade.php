<x-app-layout>
    ...
    <div class="container mx-auto p-6">
        ...
        <a href="{{ route('type.create') }}"
           class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded mb-4 inline-block">Create
            type</a>
                ...
                <tr>
                    ...
                    <td class="py-2 px-4">
                        ...
                        <form method="POST" action="{{ route('type.destroy', $item->id) }}" style="display: inline;">
                            ...
                            @method('DELETE')
                            <button type="submit"
                                    class="bg-red-500 hover:bg-red-600 text-white font-bold py-1 px-2 rounded inline-block"
